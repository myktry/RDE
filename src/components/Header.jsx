...
const Header = () => {
  ...
  return (
    <header className="bg-gradient-to-r from-red-800 to-orange-600 text-white px-8 py-4 flex justify-between items-center shadow-md fixed top-0 left-0 right-0 z-40">
      <div className="flex items-center">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 flex items-center justify-center">
            <div className="w-full h-full bg-white rounded-full flex items-center justify-center">
              <span className="text-red-800 font-bold text-xs">USeP</span>
            </div>
          </div>
          <div>
